...
public class GMailer {
    ...
    private static final String TEST_EMAIL = "mat.mielewczyk@gmail.com";
    ...
    private static Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory) throws IOException {
        ...
        GoogleClientSecrets clientSecrets =
                GoogleClientSecrets.load(jsonFactory, new InputStreamReader(GMailer.class.getResourceAsStream("/client_secret_425073778573-kmkd7qvq0pdbfva2jmm45vhb7k61f14u.apps.googleusercontent.com.json")));
